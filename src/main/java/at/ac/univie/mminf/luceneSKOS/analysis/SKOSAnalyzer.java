...
/**
 * An analyzer for expanding fields that contain either (i) URI references to SKOS concepts OR (ii) SKOS concept prefLabels as values.
 */
public class SKOSAnalyzer extends StopwordAnalyzerBase {
    ...
    public static final SKOSType[] DEFAULT_SKOS_TYPES = new SKOSType[] { SKOSType.PREF, SKOSType.ALT, SKOSType.BROADER, SKOSType.BROADERTRANSITIVE, SKOSType.NARROWER, SKOSType.NARROWERTRANSITIVE };
    ...
    public SKOSAnalyzer(final CharArraySet stopWords, SKOSEngine skosEngine, ExpansionType expansionType) {
        super(stopWords);
    ...
    public SKOSAnalyzer(CharArraySet stopWords, String skosFile, ExpansionType expansionType, int bufferSize, String... languages) throws IOException {
        super();
    ...
    public SKOSAnalyzer(String skosFile, ExpansionType expansionType, int bufferSize, String... languages) throws IOException {
        this(STOP_WORDS_SET, skosFile, expansionType, bufferSize, languages);
    }

    public SKOSAnalyzer(String skosFile, ExpansionType expansionType, int bufferSize) throws IOException {
    ...
    public SKOSAnalyzer(Reader stopwords, String skosFile, ExpansionType expansionType, int bufferSize, String... languages) throws IOException {
        this(loadStopwordSet(stopwords), skosFile, expansionType, bufferSize, languages);
    }
