...
public class SKOSFilterFactory extends TokenFilterFactory implements ResourceLoaderAware {
    ...
    public SKOSFilterFactory(Map<String, String> args) {
        ...
        System.out.println("Passed arguments: " + skosFile + " Type: " + expansionTypeString + " bufferSize: " + (bufferSizeString != null ? bufferSizeString : "Default") + " language: " + (languageString != null ? languageString : "All") + " type: " + (typeString != null ? typeString : "Default"));
    }
    ...
    public void inform(ResourceLoader loader) {
        try {
            if (skosFile.endsWith(".n3") || skosFile.endsWith(".rdf") || skosFile.endsWith(".ttl") || skosFile.endsWith(".zip")) {
                skosEngine = SKOSEngineFactory.getSKOSEngine(((SolrResourceLoader) loader).getConfigDir() + skosFile, languageString != null ? languageString.split(" ") : null);
            } else {
