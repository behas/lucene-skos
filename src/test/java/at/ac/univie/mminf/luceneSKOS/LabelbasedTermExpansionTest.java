...
/**
 * This test-case verifies and demonstrates the "Label-based term expansion" use case as described in https://code. google.com/p/lucene-skos/wiki/UseCases#UC2:_Label-based_term_expansion
 */
public class LabelbasedTermExpansionTest extends AbstractTermExpansionTest {

    /**
     * This test indexes a sample metadata record (=lucene document) having a "title", "description", and "subject" field. A search for "arms" returns that record as a result because "arms" is defined as an alternative label for "weapons", the term which is contained in the subject field.
     * 
     * @throws IOException
     */
    @Test
